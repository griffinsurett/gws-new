...
const primaryItemsClassDefaults =
  "order-2 md:order-last w-full gap-(--spacing-2xl)";
/**
...
const sectionDefaults = {
  primary: {
    ...
    headingAreaClass:
      "order-1 md:w-1/2 flex justify-center text-center md:text-left md:items-start flex-col gap-(--spacing-md) md:gap-0",
    bottomContentClass: 
  ...
  secondary: {
    ...
    headingAreaClass:
      "w-full flex flex-col md:flex-row justify-between items-center gap-(--spacing-md) md:gap-0",
    ...
    buttonsSectionClass: "mt-(--spacing-lg) flex justify-center load scale-up",
...
export const SectionVariants = {
  ...
  primaryHero: {
    ...
    topContentClass:
      "basis-4/7 min-h-screen space-y-(--spacing-xl) lg:space-y-(--spacing-xl) lg:h-auto w-80/100 mx-auto lg:w-auto flex items-start justify-center lg:justify-center flex-col md:pl-[80px]",
    imageColumnClass:
  ...
  secondaryHero: {
    ...
    contentClass: "mx-auto text-center space-y-(--spacing-md)",
    backgroundMedia: {
      image: {
        src: HeroBg,
  ...
  secondary: {
    ...
    itemsClass:
      "w-full grid grid-cols-1 md:grid-cols-2 gap-(--spacing-xl)",
  ...
  faq: {
    sectionClass: "section",
    contentClass: "w-full flex flex-col lg:flex-row justify-center items-start gap-(--spacing-lg)",
