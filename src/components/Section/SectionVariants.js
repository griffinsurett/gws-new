...
export const SectionVariants = {
  ...
  primaryHero: {
    ...
    contentClass: "relative w-9/10 md:py-0 md:w-auto h-full flex flex-col md:flex-row z-20 gap-[var(--spacing-sm)] md:gap-[var(--spacing-xs)]",
    topContentClass:
      "basis-4/7 flex items-start justify-center md:justify-center flex-col pt-[100px] pl-[20px] md:pl-[80px]",
