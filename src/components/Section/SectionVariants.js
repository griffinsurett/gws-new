...
export const SectionVariants = {
  ...
  primaryHero: {
    ...
    topContentClass:
      "basis-4/7 min-h-screen space-y-[var(--spacing-md)] md:space-y-[var(--spacing-2xl)] md:h-auto w-80/100 mx-auto md:w-auto flex items-start justify-center md:justify-center flex-col md:pl-[80px]",
    imageColumnClass:
